...
public class Runway {
	protected static int noOfRunways = 0;
	protected boolean status; // This variable denotes whether the runway is occupied or not.
	protected int runwayWaitTime; // Time status for runway during landing
