...
public class OutputGUI {
	...
	private void initialize() {
		...
		JLabel lblOptimalNumberOf = new JLabel("Optimal number of gates airport should have :"); // label for optimal
																									// number of gates
																									// to be dispalyed
		...
		JLabel lblNumberOfEmergency = new JLabel("Number of emergency landing airport can handle :"); // label for
																										// optimal
																										// number of
																										// emergency
																										// landing to be
