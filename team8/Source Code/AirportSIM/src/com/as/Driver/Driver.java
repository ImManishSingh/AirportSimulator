...
public class Driver {
	public static int rt1,rt2,rt3;  //Input runway time of plane type1(rt1), and respectively for rest of the types.
	public static int bt1,bt2,bt3,peakTime; //Input boarding time of plane type1(bt1), and respectively for rest of the types. peakTime in hours.
